...
function setup() {
	...
	leftwall  = createSprite(width/2-100, 610, 20, 100);
	leftwall.shapeColor = ('red');

	rightwall = createSprite(width/2+100, 610, 20, 100);
	rightwall.shapeColor = ('red');

	base = createSprite(width/2 , 650, 180, 20);
	base.shapeColor = ("red");
	...
	baseBody = Bodies.rectangle(width/2, 650, 180, 20, {isStatic:true});
